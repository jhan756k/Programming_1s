class MyRecursion 
{
	public static void main(String[] args) 
	{
		...
		//for(int num=1;num<=20;num++) 
		{
			...
			System.out.print("2진법 => ");
			printNotation(num,2); 
			System.out.print(": ");
			printNotation2(num,2);
			System.out.println();

			System.out.print("8진법 => ");
			printNotation(num,8);
			System.out.print(": ");
			printNotation2(num,8);
			System.out.println();

			System.out.print("16진법 => ");
	...
	public static int biCoefRecur1(int n, int k) // 일반적인 recursion
	{
		if(k==0 || k==n) return 1;
	...
	{
		if(radix!=2 && radix!=8 && radix!=16) { System.out.println("Wrong Radix, plz use 2 or 8 or 16" ); return; } // <= 2, 8, 16 이어야만 하는가?
		if(n>=radix) {
			...
			// else System.out.print(n%radix==15?"F ":n%radix==14?"E ":n%radix==13?"D ":n%radix==12?"C ":n%radix==11?"B ":n%radix==10?"A ":(n%radix)+" "); // <= 더 멋진 문장은?
		}
